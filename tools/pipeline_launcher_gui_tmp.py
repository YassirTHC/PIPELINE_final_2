        ...
        DEFAULT_CONFIG.update(
            {
                ...
                "BROLL_FETCH_PROVIDER": ",".join(_SETTINGS.fetch.providers) or "pixabay",
...
class PipelineLauncher(tk.Tk):
    ...
    def _create_widgets(self) -> None:
        ...
        self.env_vars["BROLL_FETCH_PROVIDER"] = tk.StringVar(value=DEFAULT_CONFIG.get("BROLL_FETCH_PROVIDER", "pixabay"))
        self.env_vars["FETCH_MAX"] = tk.StringVar(value=DEFAULT_CONFIG.get("FETCH_MAX", "8"))
        ttk.Label(fetch_frame, text="B-roll providers (comma list)").grid(row=0, column=0, sticky="w")
        ...
        ttk.Entry(fetch_frame, textvariable=self.env_vars["FETCH_MAX"]).grid(row=1, column=2, columnspan=2, sticky="ew")
