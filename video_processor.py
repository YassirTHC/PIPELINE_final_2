...
from video_pipeline.smart_reframe import SmartReframeConfig, smart_reframe_broll
    ...
    *,
    ...
    if engine == "pycaps":
        ...
        try:
            ...
            fallback_exc = exc
            print(f"  ?? Erreur rendu PyCaps: {exc}")
        else:
            return
        finally:
        ...
        print("  ?? Retour automatique au moteur Hormozi.")
