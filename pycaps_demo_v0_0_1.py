...
#@title âœ… Step 0: Check for GPU access
...
if torch.cuda.is_available():
    print("âœ… GPU is enabled and ready to go!")
...
#@title ðŸ› ï¸ Step 1: Install Pycaps and Dependencies (runs once)

!pip install -q git+https://github.com/francozanardi/pycaps.git
!playwright install chromium

print("âœ… Installation and setup complete!")

#@title ðŸ“¤ Step 2: Upload Your Video File
...
print(f"âœ… Video '{input_video_path}' uploaded successfully!")

#@title ðŸŽ¨ Step 3: Choose Your Style
...
def on_save_button_click(b):
  ...
  if os.path.exists(custom_template_path):
      print(f"\nâœ… Template '{selected_template}' is now ready.")
  else:
      print(f"\nâŒ Error: Failed to select the template. Check the logs above.")
...
#@title âœï¸ Step 4: Customize Your Template (Optional)
...
def on_button_click(b):
    ...
    if upload_button.value:
        ...
        for filename, content in upload_button.value.items():
            ...
            print(f"âœ… Resource '{filename}' saved.")
    else:
        print("No resources were uploaded.")

    print("âœ… Customizations saved successfully!")

button.on_click(on_button_click)

print("âœï¸ Customize the template\n")
display(styles_textarea, json_text_area, upload_button, button)

#@title ðŸ”¥ Step 5: Generate Video!
import time

print("ðŸš€ Rendering final video... This will take a few minutes.")
...
print(f"\nðŸŽ‰ Success! Your video is ready for download in the next step.")

#@title ðŸ’¾ Step 6: Download Your Final Video
from google.colab import files
